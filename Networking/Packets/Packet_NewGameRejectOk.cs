...
/// <summary>
/// A packet used by the server to indicate that rejecting a game request succeded
/// </summary>
public partial class Packet_NewGameRejectOk : AbstractPacket
{
    ...
    public static bool TryConstructPacket_NewGameRejectOkFrom(Deque<byte> buffer, [NotNullWhen(true)] out AbstractPacket? packet)
    {
        packet = null;
