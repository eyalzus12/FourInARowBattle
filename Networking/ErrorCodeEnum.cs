...
public enum ErrorCodeEnum : byte
{
    ...
    CANNOT_APPROVE_INVALID_PLAYER = 041,
    CANNOT_APPROVE_NOT_IN_LOBBY = 042,

    CANNOT_REJECT_NO_REQUEST = 050,
    CANNOT_REJECT_INVALID_PLAYER = 051,
    CANNOT_REJECT_NOT_IN_LOBBY = 052,

    CANNOT_CANCEL_NO_REQUEST = 060,
    CANNOT_CANCEL_INVALID_PLAYER = 061,
    CANNOT_CANCEL_NOT_IN_LOBBY = 062,
